...
mapview(bredband, col.regions = c("green"), cex = 15, alpha = 0, label = "perc_hom_pass")+
  ...
  mapview(fritidshusomr, lwd = 1, color = "green", alpha.regions = 0.1, legend = FALSE, homebutton = FALSE)+
  mapview(handelsomr, lwd = 1, color = "blue", alpha.regions = 0.1, legend = FALSE, homebutton = FALSE)+
  mapview(arbetsplatsomr, lwd = 1, color = "red", alpha.regions = 0.1, legend = FALSE, label = "ARBETSPLOM", homebutton = FALSE)+
  mapview(kommuner, lwd = 1, color = "grey40", alpha.regions = 0, legend = FALSE, homebutton = FALSE)
```
