...
mapview(hallplatslagen, zcol = "busslinjer", legend = FALSE, col.regions = reds(hallplatslagen$busslinjer), cex = 3, layer.name = c("Hållplatslägen"))+
  ...
  mapview(tatorter, col.regions = "orange", label = "tatort")+
  mapview(alla_linjer_aggr, color = "grey", lwd = 10, legend = FALSE)+
